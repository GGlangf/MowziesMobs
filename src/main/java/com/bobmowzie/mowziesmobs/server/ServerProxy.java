...
public class ServerProxy {
    ...
    public void initNetwork() {
        ...
        this.registerMessage(MessageJumpToAbilitySectionClientToServer.class, MessageJumpToAbilitySectionClientToServer::serialize, MessageJumpToAbilitySectionClientToServer::deserialize, new MessageJumpToAbilitySectionClientToServer.Handler(), NetworkDirection.PLAY_TO_SERVER);
