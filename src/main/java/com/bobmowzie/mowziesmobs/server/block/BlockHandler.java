...
public final class BlockHandler {
    ...
    public static final DeferredHolder<Block, Block> GONG = registerBlockAndItem("gong", () -> new GongBlock(BlockBehaviour.Properties.ofLegacyCopy(Blocks.GOLD_BLOCK).requiresCorrectToolForDrops().strength(5.0F).sound(SoundType.ANVIL)));
    public static final DeferredHolder<Block, Block> GONG_PART = REG.register("gong_part", () -> new GongBlock.GongPartBlock(BlockBehaviour.Properties.ofLegacyCopy(Blocks.GOLD_BLOCK).requiresCorrectToolForDrops().strength(5.0F).sound(SoundType.ANVIL)));
