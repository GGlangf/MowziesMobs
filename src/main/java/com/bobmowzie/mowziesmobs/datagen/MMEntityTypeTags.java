...
public class MMEntityTypeTags extends EntityTypeTagsProvider {
    ...
    private void addToVanillaTags() {
        ...
        tag(EntityTypeTags.POWDER_SNOW_WALKABLE_MOBS).add(EntityHandler.FROSTMAW.get());
    }
    ...
    private void addToCommonTags() {
        ...
        // FIXME 1.21 :: add the bosses to 'Tags.EntityTypes#CAPTURING_NOT_SUPPORTED' as well?
    }
